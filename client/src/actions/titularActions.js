...
export const mostrarTitulares = () => async dispatch => {
  await axios
    .get("http://190.231.32.232:5002/api/maestro/titulares")
    .then(res =>
      dispatch({
...
export const ultimoContrato = () => async dispatch => {
  const respuesta = await axios.get(
    "http://190.231.32.232:5002/api/maestro/lastcontrato"
  );
  dispatch({
...
export const mostrarTitular = id => async dispatch => {
  await axios
    .get(`http://190.231.32.232:5002/api/maestro/titular/${id}`)
...
export const bajaTitular = id => async dispatch => {
  await axios
    .put(`http://190.231.32.232:5002/api/maestro/baja/${id}`, id)
...
export const agregarTitular = titular => async dispatch => {
  await axios
    .post(`http://190.231.32.232:5002/api/maestro/nuevo`, titular)
