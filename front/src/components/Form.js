...
import { ultimoContrato } from "../functions/apis";
...
class Form extends Component {
  ...
  crearFormInf = e => {
    ...
    if (
      ...
      toastr.warning(
        "Los campos en rojo son obligatorios, no pueden estar vacios!!!",
        "ATENCION"
      );
    } else {
      e.preventDefault();
    ...
    return (
      <div className="">
        ...
        <div className="form-style-8">
          ...
          <GridInf formInf={this.state.titular} />
          ...
          <GridDom formDom={this.state.titular} />
        </div>
      </div>
    );
  }
